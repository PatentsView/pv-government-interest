...
temp_govt_associated_inventors_clean = temp_govt_associated_inventors_clean %>% filter(!is.na(male)) %>% filter(male %in% c("0","1"))
temp_govt_associated_inventors_clean$patent_id = temp_govt_associated_inventors_clean$patent_id %>% as.character()
temp_govt_associated_inventors_clean$male = temp_govt_associated_inventors_clean$male %>% as.double()
